CREATE TABLE IF NOT EXISTS v21_settings(id TEXT PRIMARY KEY,admin_fee INTEGER DEFAULT 0,game_fee INTEGER DEFAULT 0,bank_account TEXT DEFAULT '',access_code TEXT DEFAULT 'TIP2026',rules_html TEXT,competition_name TEXT DEFAULT 'FIFA World Cup 2026',competition_subtitle TEXT DEFAULT 'MS ve fotbale 2026',competition_logo_url TEXT DEFAULT '/worldcup2026-logo.png');
